...
public class ClassItemsLookup extends BaseLookup<Element> {
    ...
    /**
     * If the item being inherited from is from external package,
     * or items like java.lang.Object,
     * comments are not available since javadoc here is referencing compiled byte code.
     */
    ...
    CommentHelper getInheritedInlineTags(CommentHelper input) {
        ...
        List<Element> implementedMethods = utils.getImplementedMethods(input.element, new ArrayList<Element>());
