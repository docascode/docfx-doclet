...
public class YmlFilesBuilder {
    ...
    public boolean build() {
        ...
        // write content files
        packageMetadataFiles.forEach(YmlFilesBuilder::writeToYmlFilePackage);
        for (MetadataFile type : classMetadataFiles)
        {
            writeToYmlFileType(type);
        }
    ...
    private static void writeToYmlFilePackage(MetadataFile pack) {
    ...
    private void writeToYmlFileType(MetadataFile typeItem) {
